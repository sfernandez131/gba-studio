var mGBA = (() => {
  var _scriptName = (typeof document !== "undefined" && document.currentScript) ? document.currentScript.src : (typeof self !== "undefined" ? self.location.href : "");
...
function findWasmBinary() {
  ...
  return new URL('mgba.wasm', _scriptName).href;
}
...
// end include: preamble.js
  ...
  allocateUnusedWorker() {
        ...
        worker = new Worker(new URL('mgba.js', _scriptName), {
...
if (typeof window !== "undefined") window.mGBA = mGBA;
